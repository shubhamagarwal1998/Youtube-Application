...
public class YoutubeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    static final String GOOGLE_API_KEY="AIzaSyCEhpzKKTanZ8yBCezyhk0EJ0KeyxnsGmQ";
...
//        layout.addView(button1);
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        ...
        {
            String error_message=String.format("There was an error initialising Youtube Player (%1$s)",youTubeInitializationResult.toString());
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener=new YouTubePlayer.PlayerStateChangeListener() {
        ...
        Toast.makeText(YoutubeActivity.this,"Click Ad",Toast.LENGTH_LONG).show();
        }
        ...
        public void onVideoEnded() {
            Toast.makeText(YoutubeActivity.this,"Congratulations! Video completed",Toast.LENGTH_LONG).show();
        }
